import { CalendarDays, Clock, History, LayoutDashboard, QrCode, User } from 'lucide-react'
...
const navItems: BrandNavItem[] = [
  ...
  { href: '/teacher/planning', label: 'Mon planning', shortLabel: 'Planning', icon: <CalendarDays size={16} /> },
